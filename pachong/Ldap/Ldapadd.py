...
import http.cookiejar,ldapguihao
    ...
    def click(self, event):
        ...
        def login(ip,user,psw,cookie,port):
            ...
            header = {
                ...
                'Cookie': 'language=zh_CN; PHPSESSID=59e6ff9af1f514503f9b55d84291beff; x-act-flag-gcs=; x-anti-csrf-gcs=925ADE0700CAAE76; sinfor_session_id={}'.format(cookie),
                'Host': '{}:{}'.format(ip,port),
        ...
        def Ldapadd(ip,port,cookielist):
            ...
            data ={"l_bindrc_attr":"",
                   ...
                   'l_userdn':'OU={},DC=sslt,DC=com'.format(self.m_textCtrl5.GetValue()),
                   'l_subtree':'1',
                   'timeout':'15',
                   'enable':'1',
                   'authtype':'0',
