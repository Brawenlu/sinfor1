...
USER_INFO = {
    ...
    '陆文博': {
        'userkey': '58b83aaa-13f7-4852-859e-9b2b4fe0c18a'
    },
    '花花': {
        'userkey': '58b83aaa-13f7-4852-859e-9b2b4fe0c18a'
    }
...
START_TIME = '{} 22:40:00'.format(now_data)
DIFF_TIME = 3  # 本机与北京时间的最大时间差 单位：秒,值如果小于真实时间差，可能导致秒杀不到商品
